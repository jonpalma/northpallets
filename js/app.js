$(document).ready(function(){
	$('.parallax').parallax();
	$('body').scrollspy({offset: 126});
	$('#productos-link').bind('click',function(e){
      e.preventDefault();
      document.location.href="productos.php"; 
	});
	
	$('#servicios-link').bind('click',function(e){
      e.preventDefault();
      document.location.href="servicios.php"; 
	});
	
	$('#empresa-link').bind('click',function(e){
      e.preventDefault();

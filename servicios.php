...
<?php include('header.php'); ?>
    ...
    <div class="parallax-container title">
        <div class="parallax">
            <img src="img/content/servicios/parallax/1.jpg" alt="Parallax Background">
        </div>
        <div class="container">
            <h1 class="white">SERVICIOS</h1>
        </div>
    </div>
    <!-- END PARALLAX -->

    <!-- BEGIN INFO -->
    <div class="container padding" id="termico">
    ...
    <!-- BEGIN FINAL GALLERY -->
    <div class="container padding">
        <p class="center-text">Contamos con opciones para protección de embalaje como burbuja , polifoam, nieve seca entre otros</p>
        <br class="vert-margin-small">
        <!-- BEGIN CAROUSEL -->
        <div class="carousel-wrapper">
            <div id="carousel-three" class="carousel slide green" data-ride="carousel">	
                <!-- Wrapper for slides -->
